...
let RecipesController = class RecipesController {
    ...
    getIngredients(organizationId) {
        return this.recipesService.getIngredients(organizationId);
    }
    getRecipeIntelligence(menuItemId) {
...
__decorate([
    (0, common_1.Get)('intelligence/:menuItemId'),
    __param(0, (0, common_1.Param)('menuItemId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], RecipesController.prototype, "getRecipeIntelligence", null);
